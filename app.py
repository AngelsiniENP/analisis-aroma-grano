...
st.text_area("✍️ Tu explicación (Propias palabras, sin IA):",
             value=""" Este fragmento de código permite identificar la cantidad de productos únicos, los tipos de productos disponibles y la frecuencia de ventas por producto.""", key="reflexion_paso_2")
...
st.dataframe(df)
st.text_area("✍️ Tu explicación (Propias palabras, sin IA):",
             value="""Este fragmento realiza la limpieza de datos central: elimina filas duplicadas basadas en el ID, convierte la columna 'cantidad' a formato numérico (corrigiendo errores de texto) y rellena los valores nulos asumiendo una unidad por defecto.""", key="reflexion_paso_3")
...
st.text_area("✍️ Tu explicación (Propias palabras, sin IA):",
             value="""Aquí se calcula el Ingreso Bruto multiplicando precio por cantidad. Luego, se genera un reporte ejecutivo renombrando las columnas para una mejor lectura y se ordena de mayor a menor según el total de ventas.""", key="reflexion_paso_4")
...
st.table(df_final)
st.text_area("✍️ Tu explicación (Propias palabras, sin IA):",
             value="""Este bloque aplica los filtros interactivos laterales. Utiliza una máscara booleana para mostrar solo los productos que coinciden con los tipos seleccionados Y que además superen el monto mínimo definido en el slider.""", key="reflexion_paso_5")
...
st.text_area("✍️ Tu explicación (Propias palabras, sin IA):",
             value="""En esta sección agrupamos los datos por 'tipo' de producto para calcular métricas agregadas: la suma total, el conteo de ventas y el promedio de ingresos, visualizando el total en un gráfico de barras.""", key="reflexion_paso_6")
...
st.text_area("✍️ Tu explicación (Propias palabras, sin IA):",
             value="""Para finalizar, se realiza una fusión (merge) entre el DataFrame de ventas y una tabla de proveedores. Esto permite enriquecer la información de cada pedido con el nombre del proveedor correspondiente al producto.""", key="reflexion_paso_7")
